...
MOVE_DATA: dict[str, MoveProperties] = {
    ...
    'F2': MoveProperties(HD.AMBIDEXTROUS, FA.INDEX, 0.51),
    ...
    'Uw': MoveProperties(HD.RIGHT, FA.INDEX, 0.95),
    "Uw'": MoveProperties(HD.LEFT, FA.INDEX, 0.95),
