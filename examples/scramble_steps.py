...
STEP_INFO: dict[str, tuple[str, str]] = {
    ...
    'CLL': ('Corners Last Layer (corners + edges scrambled)', 'cll'),
    ...
    'CPLL': ('Corner Permutation Last Layer (corners permuted only)', 'cpll'),
    'ZZLL': ('ZZ Last Layer (phase edges, corners oriented)', 'll'),
    # F2L variants
    'F2L': ('First Two Layers (cross + 4 F2L pairs)', 'f2l'),
    'ZZF2L': ('ZZ F2L (edges oriented, R/U/L moveset)', 'zbls'),
    'ZZRB': ('ZZ Right Block (R+U pieces scrambled)', ''),
    'PETRUSF2L': ('Petrus F2L (R+U block remaining)', ''),
    # Last Slot variants
    'LS': ('Last Slot (one F2L pair + last layer)', 'ls'),
    'ELS': ('Edge Last Slot (LS with edge orientation)', 'els'),
    'ZZLS': ('ZZ Last Slot (edges oriented)', 'zbls'),
    'TSLE': ('Top Slot + Last Edge', ''),
    'CLS': ('Corner Last Slot (corner + U edges)', 'cls'),
    'CPLS': ('Corner Permutation Last Slot', 'cls'),
    'EJLS': ('Edge Just Last Slot (DFR disoriented)', 'els'),
    'EJF2L': ('Edge Just F2L', ''),
    'TTLL': ('Two-Twist Last Layer (DFR + U corners)', ''),
    'WV': ("Winter Variation (after R U R')", 'wvls'),
    'SV': ("Summer Variation (after R U' R')", 'wvls'),
    'VLS': ("Valk Last Slot (after R U' R')", 'vls'),
    'VHLS': ('Valk-Harris Last Slot', 'vls'),
    # Roux method
    'CMLL': ('Corners of Last Layer (Roux)', 'cmll'),
    'CMLLEO': ('CMLL + Edge Orientation (Roux)', 'l6eo'),
    'SB': ('Second Block (Roux R+U+DF+DB)', ''),
    # Petrus method
    'PETRUS2X2X3': ('Petrus 2x2x3 block (U+R+F scrambled)', ''),
    'PETRUSEO': ('Petrus Edge Orientation (U+F scrambled)', ''),
}
