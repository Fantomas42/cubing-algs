...
STEP_INFO: dict[str, tuple[str, str]] = {
    ...
    'TTLL': ('Two-Twist Last Layer (DFR + U corners)', 'oll'),
    'WV': ("Winter Variation (after R U R')", 'oll'),
    'SV': ("Summer Variation (after R U' R')", 'oll'),
    'VLS': ("Valk Last Slot (after R U' R')", 'oll'),
    'VHLS': ('Valk-Harris Last Slot', 'oll'),
    # Roux method
